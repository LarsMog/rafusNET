    ...
    value: function connectedCallback() {
      ...
      if (this.allowCustom) {
        this.addEventListener('keydown', function (event) {
          if (event.keyCode !== _this2.keyCode.ENTER || event.target !== _this2.choicesInstance.input.element) {
            return;
          }
          ...
          var highlighted = _this2.choicesInstance.dropdown.element.querySelector(".".concat(_this2.choicesInstance.config.classNames.highlightedState));
